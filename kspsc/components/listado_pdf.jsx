    ...
    <div>
            <div data-aos="fade-up" className="mb-4 border-b border-gray-200 dark:border-gray-700 overflow-x-auto">
                ...
                {items.map(({ titulo }, index) => (
                    ...
                    <button
                        className={`z-30 flex items-center justify-center w-full px-0 py-1 mb-0 transition-all ease-in-out border-0 rounded-lg cursor-pointer text-slate-50 bg-inherit hover:text-blue-500 hover:border-blue-500 dark:hover:text-blue-500 min-w-[8.33%] ${activeTab === index ? "text-blue-500" : ""}`}
